...
function DialogOverlay({
  ...
  return (
    <DialogPrimitive.Backdrop
      ...
      className={cn(
        "fixed inset-0 backdrop-blur-[1.5px] isolate z-50 bg-black/10 duration-100 data-open:animate-in data-open:fade-in-0 data-closed:animate-out data-closed:fade-out-0",
        className,
      )}
      {...props}
    />
